<?php mysql_connect("dirtpage1.db.6263223.hostedresource.com", "dirtpage1", "Jason7734") or die(mysql_error()); mysql_select_db("dirtpage1") or die(mysql_error());?>
...
<a href="http://www.dirtpage.com/default.php"><span style="color: green; font-size: 40px">dirt</span><span style="color:white; font-size: 40px">page</span></a></span>&nbsp;&nbsp; 
